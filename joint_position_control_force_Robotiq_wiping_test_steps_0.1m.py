...
eef_title = "End-Effector Positions (X, Y, Z) Over 0.1 seconds pressing time (300 steps) with 0.005 sleep time"
...
def joint_position_control(robot_interface, controller_cfg):
    ...
    [0.1401, 0.7541, 0.0587, -2.0613, 0.1964, 4.4184, 0.6438],
    ...
    [0.1359, 0.7532, 0.0566, -2.0634, 0.1905, 4.4188, 0.6473],
    ...
    [0.1333, 0.7527, 0.0553, -2.0647, 0.1868, 4.4190, 0.6495],
    ...
    [0.1308, 0.7522, 0.0540, -2.0660, 0.1832, 4.4193, 0.6517],
    [0.1302, 0.7521, 0.0537, -2.0662, 0.1824, 4.4193, 0.6521],
    [0.1297, 0.7520, 0.0534, -2.0665, 0.1817, 4.4193, 0.6526],
    [0.1292, 0.7518, 0.0532, -2.0667, 0.1810, 4.4194, 0.6530],
    [0.1287, 0.7517, 0.0529, -2.0670, 0.1802, 4.4194, 0.6534],
    [0.1282, 0.7516, 0.0526, -2.0672, 0.1795, 4.4195, 0.6539],
    [0.1276, 0.7515, 0.0524, -2.0674, 0.1787, 4.4195, 0.6543],
    ...
    [0.1251, 0.7510, 0.0510, -2.0686, 0.1751, 4.4198, 0.6565],
    [0.1245, 0.7509, 0.0508, -2.0689, 0.1743, 4.4198, 0.6569],
    [0.1240, 0.7508, 0.0505, -2.0691, 0.1736, 4.4199, 0.6574],
    [0.1235, 0.7507, 0.0502, -2.0693, 0.1728, 4.4199, 0.6578],
    [0.1230, 0.7506, 0.0500, -2.0696, 0.1721, 4.4199, 0.6582],
    [0.1225, 0.7505, 0.0497, -2.0698, 0.1714, 4.4200, 0.6587],
    [0.1220, 0.7504, 0.0494, -2.0700, 0.1706, 4.4200, 0.6591],
    [0.1214, 0.7503, 0.0492, -2.0703, 0.1699, 4.4201, 0.6595],
    [0.1209, 0.7502, 0.0489, -2.0705, 0.1691, 4.4201, 0.6600],
    [0.1204, 0.7501, 0.0486, -2.0707, 0.1684, 4.4202, 0.6604],
    [0.1199, 0.7500, 0.0484, -2.0709, 0.1677, 4.4202, 0.6608],
    [0.1194, 0.7499, 0.0481, -2.0712, 0.1669, 4.4203, 0.6612],
    [0.1189, 0.7498, 0.0478, -2.0714, 0.1662, 4.4203, 0.6617],
    [0.1183, 0.7497, 0.0476, -2.0716, 0.1654, 4.4203, 0.6621],
    [0.1178, 0.7497, 0.0473, -2.0718, 0.1647, 4.4204, 0.6625],
    [0.1173, 0.7496, 0.0470, -2.0721, 0.1640, 4.4204, 0.6630],
    [0.1168, 0.7495, 0.0468, -2.0723, 0.1632, 4.4205, 0.6634],
    [0.1163, 0.7494, 0.0465, -2.0725, 0.1625, 4.4205, 0.6638],
    [0.1158, 0.7493, 0.0462, -2.0727, 0.1617, 4.4206, 0.6643],
    [0.1152, 0.7492, 0.0459, -2.0729, 0.1610, 4.4206, 0.6647],
    [0.1147, 0.7491, 0.0457, -2.0731, 0.1603, 4.4206, 0.6651],
    [0.1142, 0.7490, 0.0454, -2.0734, 0.1595, 4.4207, 0.6656],
    [0.1137, 0.7489, 0.0451, -2.0736, 0.1588, 4.4207, 0.6660],
    [0.1132, 0.7488, 0.0449, -2.0738, 0.1580, 4.4208, 0.6664],
    [0.1127, 0.7487, 0.0446, -2.0740, 0.1573, 4.4208, 0.6669],
    [0.1121, 0.7486, 0.0443, -2.0742, 0.1566, 4.4208, 0.6673],
    [0.1116, 0.7486, 0.0441, -2.0744, 0.1558, 4.4209, 0.6677],
    [0.1111, 0.7485, 0.0438, -2.0746, 0.1551, 4.4209, 0.6681],
    [0.1106, 0.7484, 0.0435, -2.0748, 0.1543, 4.4210, 0.6686],
    [0.1101, 0.7483, 0.0432, -2.0750, 0.1536, 4.4210, 0.6690],
    [0.1096, 0.7482, 0.0430, -2.0752, 0.1529, 4.4210, 0.6694],
    [0.1090, 0.7481, 0.0427, -2.0754, 0.1521, 4.4211, 0.6699],
    [0.1085, 0.7480, 0.0424, -2.0756, 0.1514, 4.4211, 0.6703],
    [0.1080, 0.7479, 0.0422, -2.0758, 0.1506, 4.4212, 0.6707],
    [0.1075, 0.7479, 0.0419, -2.0760, 0.1499, 4.4212, 0.6712],
    [0.1070, 0.7478, 0.0416, -2.0762, 0.1491, 4.4212, 0.6716],
    [0.1064, 0.7477, 0.0414, -2.0764, 0.1484, 4.4213, 0.6720],
    [0.1059, 0.7476, 0.0411, -2.0766, 0.1477, 4.4213, 0.6724],
    [0.1054, 0.7475, 0.0408, -2.0768, 0.1469, 4.4214, 0.6729],
    [0.1049, 0.7474, 0.0405, -2.0770, 0.1462, 4.4214, 0.6733],
    [0.1044, 0.7474, 0.0403, -2.0772, 0.1454, 4.4214, 0.6737],
    [0.1039, 0.7473, 0.0400, -2.0774, 0.1447, 4.4215, 0.6742],
    [0.1033, 0.7472, 0.0397, -2.0776, 0.1439, 4.4215, 0.6746],
    [0.1028, 0.7471, 0.0395, -2.0778, 0.1432, 4.4215, 0.6750],
    [0.1023, 0.7470, 0.0392, -2.0780, 0.1425, 4.4216, 0.6754],
    [0.1018, 0.7469, 0.0389, -2.0782, 0.1417, 4.4216, 0.6759],
    [0.1013, 0.7469, 0.0386, -2.0784, 0.1410, 4.4217, 0.6763],
    [0.1008, 0.7468, 0.0384, -2.0786, 0.1402, 4.4217, 0.6767],
    [0.1002, 0.7467, 0.0381, -2.0787, 0.1395, 4.4217, 0.6771],
    [0.0997, 0.7466, 0.0378, -2.0789, 0.1387, 4.4218, 0.6776],
    [0.0992, 0.7466, 0.0375, -2.0791, 0.1380, 4.4218, 0.6780],
    [0.0987, 0.7465, 0.0373, -2.0793, 0.1373, 4.4218, 0.6784],
    [0.0982, 0.7464, 0.0370, -2.0795, 0.1365, 4.4219, 0.6789],
    [0.0977, 0.7463, 0.0367, -2.0797, 0.1358, 4.4219, 0.6793],
    [0.0971, 0.7462, 0.0365, -2.0798, 0.1350, 4.4219, 0.6797],
    [0.0966, 0.7462, 0.0362, -2.0800, 0.1343, 4.4220, 0.6801],
    [0.0961, 0.7461, 0.0359, -2.0802, 0.1335, 4.4220, 0.6806],
    [0.0956, 0.7460, 0.0356, -2.0804, 0.1328, 4.4220, 0.6810],
    [0.0951, 0.7459, 0.0354, -2.0805, 0.1320, 4.4221, 0.6814],
    [0.0945, 0.7459, 0.0351, -2.0807, 0.1313, 4.4221, 0.6818],
    [0.0940, 0.7458, 0.0348, -2.0809, 0.1306, 4.4221, 0.6823],
    [0.0935, 0.7457, 0.0345, -2.0811, 0.1298, 4.4222, 0.6827],
    [0.0930, 0.7457, 0.0343, -2.0812, 0.1291, 4.4222, 0.6831],
    [0.0925, 0.7456, 0.0340, -2.0814, 0.1283, 4.4223, 0.6835],
    [0.0920, 0.7455, 0.0337, -2.0816, 0.1276, 4.4223, 0.6840],
    ...
    [0.0894, 0.7452, 0.0324, -2.0824, 0.1238, 4.4224, 0.6861],
    [0.0889, 0.7451, 0.0321, -2.0826, 0.1231, 4.4225, 0.6865],
    [0.0883, 0.7450, 0.0318, -2.0827, 0.1223, 4.4225, 0.6869],
    [0.0878, 0.7449, 0.0315, -2.0829, 0.1216, 4.4225, 0.6874],
    [0.0873, 0.7449, 0.0313, -2.0830, 0.1209, 4.4226, 0.6878],
    [0.0868, 0.7448, 0.0310, -2.0832, 0.1201, 4.4226, 0.6882],
    [0.0863, 0.7447, 0.0307, -2.0834, 0.1194, 4.4226, 0.6886],
    [0.0857, 0.7447, 0.0304, -2.0835, 0.1186, 4.4227, 0.6891],
    [0.0852, 0.7446, 0.0302, -2.0837, 0.1179, 4.4227, 0.6895],
    [0.0847, 0.7446, 0.0299, -2.0838, 0.1171, 4.4227, 0.6899],
    [0.0842, 0.7445, 0.0296, -2.0840, 0.1164, 4.4228, 0.6903],
    [0.0837, 0.7444, 0.0293, -2.0841, 0.1156, 4.4228, 0.6908],
    [0.0832, 0.7444, 0.0291, -2.0843, 0.1149, 4.4228, 0.6912],
    [0.0826, 0.7443, 0.0288, -2.0844, 0.1141, 4.4229, 0.6916],
    [0.0821, 0.7442, 0.0285, -2.0846, 0.1134, 4.4229, 0.6920],
    [0.0816, 0.7442, 0.0282, -2.0847, 0.1126, 4.4229, 0.6925],
    [0.0811, 0.7441, 0.0280, -2.0849, 0.1119, 4.4229, 0.6929],
    [0.0806, 0.7440, 0.0277, -2.0850, 0.1111, 4.4230, 0.6933],
    [0.0801, 0.7440, 0.0274, -2.0852, 0.1104, 4.4230, 0.6937],
    [0.0795, 0.7439, 0.0271, -2.0853, 0.1097, 4.4230, 0.6942],
    [0.0790, 0.7439, 0.0269, -2.0854, 0.1089, 4.4231, 0.6946],
    [0.0785, 0.7438, 0.0266, -2.0856, 0.1082, 4.4231, 0.6950],
    [0.0780, 0.7437, 0.0263, -2.0857, 0.1074, 4.4231, 0.6954],
    [0.0775, 0.7437, 0.0260, -2.0859, 0.1067, 4.4231, 0.6958],
    [0.0769, 0.7436, 0.0257, -2.0860, 0.1059, 4.4232, 0.6963],
    [0.0764, 0.7436, 0.0255, -2.0861, 0.1052, 4.4232, 0.6967],
    [0.0759, 0.7435, 0.0252, -2.0863, 0.1044, 4.4232, 0.6971],
    [0.0754, 0.7435, 0.0249, -2.0864, 0.1037, 4.4232, 0.6975],
    [0.0749, 0.7434, 0.0246, -2.0865, 0.1029, 4.4233, 0.6980],
    [0.0744, 0.7433, 0.0244, -2.0867, 0.1022, 4.4233, 0.6984],
    [0.0738, 0.7433, 0.0241, -2.0868, 0.1014, 4.4233, 0.6988],
    [0.0733, 0.7432, 0.0238, -2.0869, 0.1007, 4.4234, 0.6992],
    [0.0728, 0.7432, 0.0235, -2.0871, 0.0999, 4.4234, 0.6996],
    [0.0723, 0.7431, 0.0233, -2.0872, 0.0992, 4.4234, 0.7001],
    [0.0718, 0.7431, 0.0230, -2.0873, 0.0984, 4.4234, 0.7005],
    [0.0713, 0.7430, 0.0227, -2.0874, 0.0977, 4.4235, 0.7009],
    [0.0707, 0.7430, 0.0224, -2.0876, 0.0969, 4.4235, 0.7013],
    [0.0702, 0.7429, 0.0222, -2.0877, 0.0962, 4.4235, 0.7018],
    [0.0697, 0.7429, 0.0219, -2.0878, 0.0954, 4.4235, 0.7022],
    [0.0692, 0.7428, 0.0216, -2.0879, 0.0947, 4.4236, 0.7026],
    [0.0687, 0.7428, 0.0213, -2.0881, 0.0939, 4.4236, 0.7030],
    [0.0681, 0.7427, 0.0210, -2.0882, 0.0932, 4.4236, 0.7034],
    [0.0676, 0.7427, 0.0208, -2.0883, 0.0924, 4.4236, 0.7039],
    [0.0671, 0.7426, 0.0205, -2.0884, 0.0917, 4.4237, 0.7043],
    [0.0666, 0.7426, 0.0202, -2.0885, 0.0909, 4.4237, 0.7047],
    [0.0661, 0.7425, 0.0199, -2.0886, 0.0902, 4.4237, 0.7051],
    [0.0656, 0.7425, 0.0197, -2.0888, 0.0894, 4.4237, 0.7055],
    [0.0650, 0.7424, 0.0194, -2.0889, 0.0887, 4.4238, 0.7060],
    [0.0645, 0.7424, 0.0191, -2.0890, 0.0879, 4.4238, 0.7064],
    [0.0640, 0.7423, 0.0188, -2.0891, 0.0872, 4.4238, 0.7068],
    [0.0635, 0.7423, 0.0185, -2.0892, 0.0864, 4.4238, 0.7072],
    [0.0630, 0.7422, 0.0183, -2.0893, 0.0857, 4.4238, 0.7077],
    [0.0624, 0.7422, 0.0180, -2.0894, 0.0849, 4.4239, 0.7081],
    [0.0619, 0.7421, 0.0177, -2.0895, 0.0842, 4.4239, 0.7085],
    [0.0614, 0.7421, 0.0174, -2.0896, 0.0834, 4.4239, 0.7089],
    [0.0609, 0.7421, 0.0172, -2.0897, 0.0827, 4.4239, 0.7093],
    [0.0604, 0.7420, 0.0169, -2.0898, 0.0819, 4.4240, 0.7098],
    [0.0599, 0.7420, 0.0166, -2.0900, 0.0812, 4.4240, 0.7102],
    [0.0593, 0.7419, 0.0163, -2.0901, 0.0804, 4.4240, 0.7106],
    [0.0588, 0.7419, 0.0160, -2.0902, 0.0797, 4.4240, 0.7110],
    [0.0583, 0.7418, 0.0158, -2.0903, 0.0789, 4.4240, 0.7114],
    [0.0578, 0.7418, 0.0155, -2.0904, 0.0782, 4.4241, 0.7119],
    [0.0573, 0.7418, 0.0152, -2.0905, 0.0774, 4.4241, 0.7123],
    [0.0567, 0.7417, 0.0149, -2.0905, 0.0767, 4.4241, 0.7127],
    [0.0562, 0.7417, 0.0147, -2.0906, 0.0759, 4.4241, 0.7131],
    [0.0557, 0.7416, 0.0144, -2.0907, 0.0752, 4.4241, 0.7135],
    [0.0552, 0.7416, 0.0141, -2.0908, 0.0744, 4.4242, 0.7140],
    [0.0547, 0.7416, 0.0138, -2.0909, 0.0737, 4.4242, 0.7144],
    [0.0542, 0.7415, 0.0135, -2.0910, 0.0729, 4.4242, 0.7148],
    [0.0536, 0.7415, 0.0133, -2.0911, 0.0722, 4.4242, 0.7152],
    [0.0531, 0.7414, 0.0130, -2.0912, 0.0714, 4.4242, 0.7156],
    [0.0526, 0.7414, 0.0127, -2.0913, 0.0707, 4.4243, 0.7160],
    [0.0521, 0.7414, 0.0124, -2.0914, 0.0699, 4.4243, 0.7165],
    [0.0516, 0.7413, 0.0121, -2.0915, 0.0692, 4.4243, 0.7169],
    [0.0510, 0.7413, 0.0119, -2.0915, 0.0684, 4.4243, 0.7173],
    [0.0505, 0.7413, 0.0116, -2.0916, 0.0677, 4.4243, 0.7177],
    [0.0500, 0.7412, 0.0113, -2.0917, 0.0669, 4.4243, 0.7181],
    [0.0495, 0.7412, 0.0110, -2.0918, 0.0662, 4.4244, 0.7186],
    [0.0490, 0.7412, 0.0107, -2.0919, 0.0654, 4.4244, 0.7190],
    [0.0485, 0.7411, 0.0105, -2.0920, 0.0647, 4.4244, 0.7194],
    [0.0479, 0.7411, 0.0102, -2.0920, 0.0639, 4.4244, 0.7198],
    [0.0474, 0.7411, 0.0099, -2.0921, 0.0632, 4.4244, 0.7202],
    [0.0469, 0.7410, 0.0096, -2.0922, 0.0624, 4.4244, 0.7207],
    [0.0464, 0.7410, 0.0094, -2.0923, 0.0617, 4.4245, 0.7211],
    [0.0459, 0.7410, 0.0091, -2.0923, 0.0609, 4.4245, 0.7215],
    [0.0453, 0.7409, 0.0088, -2.0924, 0.0602, 4.4245, 0.7219],
    [0.0448, 0.7409, 0.0085, -2.0925, 0.0594, 4.4245, 0.7223],
    [0.0443, 0.7409, 0.0082, -2.0926, 0.0587, 4.4245, 0.7228],
    [0.0438, 0.7409, 0.0080, -2.0926, 0.0579, 4.4245, 0.7232],
    [0.0433, 0.7408, 0.0077, -2.0927, 0.0571, 4.4246, 0.7236],
    [0.0428, 0.7408, 0.0074, -2.0928, 0.0564, 4.4246, 0.7240],
    [0.0422, 0.7408, 0.0071, -2.0928, 0.0556, 4.4246, 0.7244],
    [0.0417, 0.7407, 0.0068, -2.0929, 0.0549, 4.4246, 0.7248],
    [0.0412, 0.7407, 0.0066, -2.0930, 0.0541, 4.4246, 0.7253],
    [0.0407, 0.7407, 0.0063, -2.0930, 0.0534, 4.4246, 0.7257],
    [0.0402, 0.7407, 0.0060, -2.0931, 0.0526, 4.4246, 0.7261],
    [0.0396, 0.7406, 0.0057, -2.0931, 0.0519, 4.4247, 0.7265],
    [0.0391, 0.7406, 0.0054, -2.0932, 0.0511, 4.4247, 0.7269],
    ...
    [0.0365, 0.7405, 0.0040, -2.0935, 0.0474, 4.4247, 0.7290],
    [0.0360, 0.7405, 0.0038, -2.0935, 0.0466, 4.4247, 0.7294],
    [0.0355, 0.7405, 0.0035, -2.0936, 0.0459, 4.4248, 0.7299],
    [0.0350, 0.7404, 0.0032, -2.0937, 0.0451, 4.4248, 0.7303],
    ...
    [0.0329, 0.7404, 0.0021, -2.0939, 0.0421, 4.4248, 0.7319],
    [0.0324, 0.7403, 0.0018, -2.0939, 0.0414, 4.4248, 0.7324],
    [0.0319, 0.7403, 0.0015, -2.0939, 0.0406, 4.4248, 0.7328],
    [0.0313, 0.7403, 0.0012, -2.0940, 0.0398, 4.4248, 0.7332],
    [0.0308, 0.7403, 0.0010, -2.0940, 0.0391, 4.4249, 0.7336],
    [0.0303, 0.7403, 0.0007, -2.0941, 0.0383, 4.4249, 0.7340],
    [0.0298, 0.7403, 0.0004, -2.0941, 0.0376, 4.4249, 0.7345],
    [0.0293, 0.7402, 0.0001, -2.0942, 0.0368, 4.4249, 0.7349],
    [0.0288, 0.7402, -0.0002, -2.0942, 0.0361, 4.4249, 0.7353],
    [0.0282, 0.7402, -0.0004, -2.0942, 0.0353, 4.4249, 0.7357],
    [0.0277, 0.7402, -0.0007, -2.0943, 0.0346, 4.4249, 0.7361],
    [0.0272, 0.7402, -0.0010, -2.0943, 0.0338, 4.4249, 0.7365],
    [0.0267, 0.7402, -0.0013, -2.0943, 0.0331, 4.4249, 0.7370],
    [0.0262, 0.7401, -0.0016, -2.0944, 0.0323, 4.4249, 0.7374],
    [0.0256, 0.7401, -0.0018, -2.0944, 0.0316, 4.4249, 0.7378],
    [0.0251, 0.7401, -0.0021, -2.0944, 0.0308, 4.4250, 0.7382],
    [0.0246, 0.7401, -0.0024, -2.0945, 0.0301, 4.4250, 0.7386],
    [0.0241, 0.7401, -0.0027, -2.0945, 0.0293, 4.4250, 0.7390],
    [0.0236, 0.7401, -0.0030, -2.0945, 0.0286, 4.4250, 0.7395],
    [0.0230, 0.7401, -0.0032, -2.0946, 0.0278, 4.4250, 0.7399],
    [0.0225, 0.7401, -0.0035, -2.0946, 0.0270, 4.4250, 0.7403],
    [0.0220, 0.7401, -0.0038, -2.0946, 0.0263, 4.4250, 0.7407],
    [0.0215, 0.7400, -0.0041, -2.0946, 0.0255, 4.4250, 0.7411],
    [0.0210, 0.7400, -0.0044, -2.0947, 0.0248, 4.4250, 0.7415],
    [0.0205, 0.7400, -0.0047, -2.0947, 0.0240, 4.4250, 0.7420],
    [0.0199, 0.7400, -0.0049, -2.0947, 0.0233, 4.4250, 0.7424],
    [0.0194, 0.7400, -0.0052, -2.0947, 0.0225, 4.4250, 0.7428],
    [0.0189, 0.7400, -0.0055, -2.0948, 0.0218, 4.4250, 0.7432],
    ...
    [0.0163, 0.7400, -0.0069, -2.0948, 0.0180, 4.4251, 0.7453],
    [0.0158, 0.7400, -0.0072, -2.0948, 0.0173, 4.4251, 0.7457],
    [0.0153, 0.7400, -0.0075, -2.0949, 0.0165, 4.4251, 0.7461],
    [0.0148, 0.7400, -0.0077, -2.0949, 0.0158, 4.4251, 0.7465],
    [0.0142, 0.7400, -0.0080, -2.0949, 0.0150, 4.4251, 0.7470],
    [0.0137, 0.7400, -0.0083, -2.0949, 0.0142, 4.4251, 0.7474],
    [0.0132, 0.7400, -0.0086, -2.0949, 0.0135, 4.4251, 0.7478],
    [0.0127, 0.7400, -0.0089, -2.0949, 0.0127, 4.4251, 0.7482],
    [0.0122, 0.7400, -0.0091, -2.0949, 0.0120, 4.4251, 0.7486],
    [0.0116, 0.7400, -0.0094, -2.0949, 0.0112, 4.4251, 0.7490],
    [0.0111, 0.7400, -0.0097, -2.0949, 0.0105, 4.4251, 0.7495],
    [0.0106, 0.7400, -0.0100, -2.0949, 0.0097, 4.4251, 0.7499],
    [0.0101, 0.7400, -0.0103, -2.0949, 0.0090, 4.4251, 0.7503],
    [0.0096, 0.7400, -0.0105, -2.0949, 0.0082, 4.4251, 0.7507],
    [0.0090, 0.7400, -0.0108, -2.0949, 0.0075, 4.4251, 0.7511],
    [0.0085, 0.7400, -0.0111, -2.0949, 0.0067, 4.4251, 0.7515],
    [0.0080, 0.7400, -0.0114, -2.0949, 0.0060, 4.4251, 0.7520],
    [0.0075, 0.7400, -0.0117, -2.0949, 0.0052, 4.4251, 0.7524],
    [0.0070, 0.7400, -0.0119, -2.0949, 0.0045, 4.4251, 0.7528],
    [0.0065, 0.7400, -0.0122, -2.0949, 0.0037, 4.4251, 0.7532],
    [0.0059, 0.7400, -0.0125, -2.0949, 0.0030, 4.4251, 0.7536],
    [0.0054, 0.7400, -0.0128, -2.0949, 0.0022, 4.4251, 0.7540],
    [0.0049, 0.7400, -0.0131, -2.0949, 0.0014, 4.4251, 0.7545],
    [0.0044, 0.7400, -0.0134, -2.0949, 0.0007, 4.4251, 0.7549],
    [0.0039, 0.7400, -0.0136, -2.0949, -0.0001, 4.4251, 0.7553],
    [0.0033, 0.7400, -0.0139, -2.0948, -0.0008, 4.4251, 0.7557],
    [0.0028, 0.7400, -0.0142, -2.0948, -0.0016, 4.4251, 0.7561],
    [0.0023, 0.7400, -0.0145, -2.0948, -0.0023, 4.4251, 0.7565],
    [0.0018, 0.7400, -0.0148, -2.0948, -0.0031, 4.4251, 0.7570],
    [0.0013, 0.7400, -0.0150, -2.0948, -0.0038, 4.4251, 0.7574],
    [0.0007, 0.7401, -0.0153, -2.0948, -0.0046, 4.4251, 0.7578],
    [0.0002, 0.7401, -0.0156, -2.0948, -0.0053, 4.4251, 0.7582],
    [-0.0003, 0.7401, -0.0159, -2.0947, -0.0061, 4.4251, 0.7586],
    [-0.0008, 0.7401, -0.0162, -2.0947, -0.0068, 4.4251, 0.7590],
    [-0.0013, 0.7401, -0.0164, -2.0947, -0.0076, 4.4251, 0.7595],
    [-0.0018, 0.7401, -0.0167, -2.0947, -0.0083, 4.4251, 0.7599],
    [-0.0024, 0.7401, -0.0170, -2.0946, -0.0091, 4.4251, 0.7603],
    [-0.0029, 0.7401, -0.0173, -2.0946, -0.0098, 4.4251, 0.7607],
    [-0.0034, 0.7401, -0.0176, -2.0946, -0.0106, 4.4251, 0.7611],
    [-0.0039, 0.7402, -0.0178, -2.0946, -0.0114, 4.4251, 0.7616],
    [-0.0044, 0.7402, -0.0181, -2.0945, -0.0121, 4.4251, 0.7620],
    [-0.0050, 0.7402, -0.0184, -2.0945, -0.0129, 4.4251, 0.7624],
    [-0.0055, 0.7402, -0.0187, -2.0945, -0.0136, 4.4251, 0.7628],
    [-0.0060, 0.7402, -0.0190, -2.0945, -0.0144, 4.4251, 0.7632],
    [-0.0065, 0.7402, -0.0192, -2.0944, -0.0151, 4.4251, 0.7636],
    [-0.0070, 0.7402, -0.0195, -2.0944, -0.0159, 4.4251, 0.7641],
    [-0.0076, 0.7403, -0.0198, -2.0944, -0.0166, 4.4251, 0.7645],
    [-0.0081, 0.7403, -0.0201, -2.0943, -0.0174, 4.4251, 0.7649],
    [-0.0086, 0.7403, -0.0204, -2.0943, -0.0181, 4.4251, 0.7653],
    [-0.0091, 0.7403, -0.0206, -2.0942, -0.0189, 4.4250, 0.7657],
    [-0.0096, 0.7403, -0.0209, -2.0942, -0.0196, 4.4250, 0.7661],
