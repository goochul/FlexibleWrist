...
def joint_position_control(robot_interface, controller_cfg):
    reset_joint_positions =  [0.0045, 0.4641, -0.0031, -2.5170, 0.0037, 3.9922, 0.0011]
    des_joint_positions = [0.0045, 0.4641, -0.0031, -2.5170, 0.0037, 3.9922, 0.0011]

    # [0.0036, 0.9684, -0.0032, -1.8179, 0.0038, 3.7974, 0.0016]



    # [0.0061, 0.2437, -0.0046, -2.5701, 0.0049, 3.7030, 0.0]
