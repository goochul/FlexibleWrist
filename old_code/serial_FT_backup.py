...
# Now, re-initialize the force sensor with the calculated offset
...
if __name__ == "__main__":
    # Initial calibration and offset calculation
    print("Calibration complete. Press Enter to start the test.")
