...
max_force_index = force_data['Force Magnitude'].idxmax()
max_force = force_data.loc[max_force_index, 'Force Magnitude']
max_force_timestamp = force_data.loc[max_force_index, 'Timestamp']

print(f"Maximum Force: {max_force:.2f} N at Timestamp: {max_force_timestamp:.2f}s")

# Plotting the force data on the time domain and saving
fig, ax1 = plt.subplots(figsize=(12, 6))

# Plot force data
ax1.plot(force_data["Timestamp"], force_data["Force Magnitude"], label="Force Magnitude", color='tab:blue', linewidth=2)
...
time_plot_path = file_PATH / "pure_force.png"
