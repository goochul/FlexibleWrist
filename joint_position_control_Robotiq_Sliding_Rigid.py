...
def joint_position_control(robot_interface, controller_cfg):
    ...
    initial_positions = [0.0045, 0.4641, -0.0031, -2.5170, 0.0037, 3.9922, 0.0011]

    approach_positions = [0.0032, 1.0299, -0.0026, -1.7752, 0.0039, 3.8162, 0.0013]

    # 0mm: [0.0033, 0.9763, -0.0027, -1.8127, 0.0039, 3.8001, 0.0012]
    # 5mm: [0.0033, 0.9895, -0.0027, -1.8038, 0.0039, 3.8043, 0.0012]
    # 10mm: [0.0033, 1.0030, -0.0027, -1.7944, 0.0039, 3.8085, 0.0013]
    # 20mm: [0.0032, 1.0299, -0.0026, -1.7752, 0.0039, 3.8162, 0.0013]
