...
def joint_position_control(robot_interface, controller_cfg):
    ...
    loading_positions = [
    [0.0079, 0.0995, -0.0056, -2.5780, 0.0085, 4.2668, 0.7432],
    [0.0063, 0.6015, -0.0056, -1.9895, 0.0082, 4.1803, 0.7453]

    ]
    
    # [-0.0896, 0.8878, -0.0601, -2.0298, -0.1237, 4.5136, 0.8201]
    # [-0.0888, 1.0518, -0.0441, -1.6213, -0.1158, 4.2690, 0.8368]\
    # [-0.0988, 1.3646, -0.0233, -0.9628, -0.1388, 3.9240, 0.8698]
